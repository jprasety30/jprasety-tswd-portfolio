...
The bar chart highlights the top 10 STEM majors with the lowest debt-to-income ratios, demonstrating which fields provide the most financial relief early on. Nuclear Engineering Technology tops the list with an exceptionally low DTI of 0.11, followed closely by Systems Engineering and various branches of Computer and Electrical Engineering. These programs combine relatively modest debt levels with strong starting salaries—making them standout options for students aiming for strong ROI.
...
This bar chart shows the 10 STEM majors with the highest debt-to-income ratios one year after graduation. Degrees like Agriculture/Veterinary, Astronomy, and Evolutionary Biology exceed DTI ratios of 1.4–1.8—meaning students owe more than their annual income. Despite being science-focused, these programs may leave graduates in financially vulnerable positions due to high debt or underwhelming salary outcomes.

(NOTE: Graph suject to change)

<div class='tableauPlaceholder' id='viz1744877965384' style='position: relative'><noscript><a href='#'><img alt='Top 10 STEM Majors With Highest Debt-to-income Ratio ' src='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;Fi&#47;FinalProjectChart2_17442584742100&#47;Sheet2&#47;1_rss.png' style='border: none' /></a></noscript><object class='tableauViz'  style='display:none;'><param name='host_url' value='https%3A%2F%2Fpublic.tableau.com%2F' /> <param name='embed_code_version' value='3' /> <param name='site_root' value='' /><param name='name' value='FinalProjectChart2_17442584742100&#47;Sheet2' /><param name='tabs' value='no' /><param name='toolbar' value='yes' /><param name='static_image' value='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;Fi&#47;FinalProjectChart2_17442584742100&#47;Sheet2&#47;1.png' /> <param name='animate_transition' value='yes' /><param name='display_static_image' value='yes' /><param name='display_spinner' value='yes' /><param name='display_overlay' value='yes' /><param name='display_count' value='yes' /><param name='language' value='en-US' /></object></div>                
<script type='text/javascript'>                    
 var divElement = document.getElementById('viz1744877965384');                    
 var vizElement = divElement.getElementsByTagName('object')[0];                    vizElement.style.width='100%';vizElement.style.height=(divElement.offsetWidth*0.75)+'px';                    
 var scriptElement = document.createElement('script');                    
 scriptElement.src = 'https://public.tableau.com/javascripts/api/viz_v1.js';                    
 vizElement.parentNode.insertBefore(scriptElement, vizElement);                
...
A scatterplot visualizes the stark divide, plotting majors by earnings and debt. This visual section brings the contrast full circle by mapping all STEM majors by area of study on a scatter chart. It helps readers visually distinguish between high-return and high-risk majors, reinforcing the central argument that 'STEM' is not a one-size-fits-all financial decision.

The scatterplot compares average earnings against median debt for each STEM major, color-coded by area of study. This layout reveals meaningful clusters: Engineering and Computer Science degrees tend to fall in the bottom-right quadrant—indicating high earnings and low debt. Conversely, many Biological and Physical Science majors appear in the top-left quadrant, signaling low earnings and higher debt. The visualization drives home the point that not all science degrees offer the same financial payoff.
...
User interviews revealed that viewers found the visualizations engaging and informative, with each chart contributing unique value to the story. The first bar chart showcasing low-risk majors was praised for its clarity, especially with recognizable fields like nursing and engineering. The second chart on high-risk majors was impactful but caused some confusion due to its color scale and lack of reference values. The third scatterplot was seen as the most powerful visual overall, clearly communicating the disparity in outcomes—but it required additional guidance, such as quadrant explanations and income benchmarks. Across all three interviews, participants emphasized the need for clearer definitions of debt-to-income ratio, better labeling, and context to interpret the visuals confidently. These insights directly inform planned design enhancements in Part III, aimed at improving clarity, accessibility, and user comprehension.
...
|What stands out in visuals?	| Bar chart with green theme felt encouraging	| The significant contrast between top and bottom majors were significant	| The scatterplot showed contrast and clear value gaps|
|Most informative visual?	| TOP 10 best ROI chart	| Top 10 worst ROI chart | Scatterplot | 
|Anything confusing?	| Didn’t understand “debt-to-income” at first	| Color legend not obvious in chart 2	| Needed more labelling on scatterplot | 
|Suggestions for improvement?	| Add short explanation of how DTI is calculated	| Add earning and debt values on bars| Label axes clearly, add benchmark lines, explain quadrant more (which section is supposed to be good) |
...
|------------------------------------------|---------------------------------------------------------------------------------|
| DTI ratio concept unclear to general audiences | Add a 1–2 sentence explainer above each chart and on hover tooltips |
| Color legend in underperforming majors chart unclear | Switch to color ratio between debt and income |
| Scatterplot lacked interpretation guidance | Add labeled reference lines + a quadrant key to explain "best" vs. "worst" zones |
| Audience wants real-world framing (salary, payoff time) | Include tooltips or callouts showing "Avg. $X earnings vs. $Y debt = Z% DTI" |
| Value of nursing/health fields surprised users | Highlight those majors more clearly in text interpretation and chart callouts |

# Final Thoughts
This project aims to bridge the gap between data and decision-making for prospective students and their families. The feedback collected through interviews emphasized not just the value of the visualizations themselves, but the importance of how they are framed and interpreted. As I move into Part III, the focus will be on tightening the narrative, making the charts more intuitive, and giving readers clear takeaways they can act on. Ultimately, the goal is to empower students to choose their major not just based on passion or prestige—but with a clearer understanding of the financial path that comes with it.
